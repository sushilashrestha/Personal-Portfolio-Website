...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Sushila Shrestha
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a creative designer based in Nepal, and I am very passionate and dedicated to my work.</p>
